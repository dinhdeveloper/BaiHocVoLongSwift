//
//  CellColectionViewCateogory.swift
//  BBProject
//
...
class CellColectionViewCateogory: BaseCollectionCell, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    lazy var colect : BaseCollectionView = {
        ...
        colect.register(CategoryCell.self, forCellWithReuseIdentifier: "CategoryCell")
